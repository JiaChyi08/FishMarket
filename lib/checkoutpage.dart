...
class CheckOutPage extends StatefulWidget {
  ...
  const CheckOutPage({Key key, this.user, this.total})
      : super(key: key);
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          primary: Color.fromRGBO(60, 177, 178, 10),
                                        ),
                                        ),
                                      ),
                                      Divider(
                                      ...
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          child: Text("Map",style:TextStyle(fontWeight: FontWeight.bold)),
                                          style: ElevatedButton.styleFrom(
                                          primary: Color.fromRGBO(42, 145, 152, 10),
                                        )
                                        ),
                                      ),
                                    ],
                      ...
                      await Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => PayScreen(user: User(
                                  email: widget.user.email, name: _name,phone: _phone,amount: widget.total.toStringAsFixed(2)),
                        ),
                      )
                      );
                    },
